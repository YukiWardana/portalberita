    ...
    <main class="flex justify-center items-start gap-4 mt-8 px-6">
        ...
        <div class="w-full md:w-3/5 bg-white p-6 rounded-lg shadow flex flex-col space-y-6">
            <div class="flex flex-col md:flex-row gap-6">
                <!-- Teks Berita -->
                <div class="flex-1">
                    <h1 class="text-3xl font-bold mb-2">Handphone Terbaik Milik Vivo Saat Ini</h1>
                ...
                <div class="w-full md:w-2/5">
                    <img src="/Images/berita2.png" alt="Gambar Berita" class="w-full h-auto object-cover rounded-lg">
                </div>
            </div>
        </div>
